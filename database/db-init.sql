...
-- =============================================================================
-- GL_CODES TABLE
-- Stores standardized General Ledger classification codes used for mapping
-- and reporting. Minimal shape to support CRUD + CSV import.
-- =============================================================================
...
-- Ensure code is unique case-insensitively for idempotency and clean imports
...
-- =============================================================================
-- USER SESSIONS TABLE (express-session store)
-- Used by connect-pg-simple for server-side sessions
-- =============================================================================
